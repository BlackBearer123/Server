...
models = {
    "french": {
        "tokenizer": MarianTokenizer.from_pretrained("./french_tokenizer"),
        "model": MarianMTModel.from_pretrained("./french_model")
    },
    "german": {
        "tokenizer": MarianTokenizer.from_pretrained("./german_tokenizer"),
        "model": MarianMTModel.from_pretrained("./german_model")
    },
    "spanish": {
        "tokenizer": MarianTokenizer.from_pretrained("./spanish_tokenizer"),
        "model": MarianMTModel.from_pretrained("./spanish_model")
    }
}
